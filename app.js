...
loadMoreBtn1.onclick = () => {
    ...
    currentItem1 += 4;
    if (currentItem1 >= boxes.length) loadMoreBtn1.style.display = "none";
};
...
loadMoreBtn2.onclick = () => {
    ...
    currentItem2 += 4;
    if (currentItem2 >= boxes.length) loadMoreBtn2.style.display = "none";
};
...
loadMoreBtn3.onclick = () => {
    ...
    currentItem3 += 4;
    if (currentItem3 >= boxes.length) loadMoreBtn3.style.display = "none";
};